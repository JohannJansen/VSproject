...
public class InputProcessorImplementation implements InputProcessor {
    private GameControllerClient gameControllerClient;

    public InputProcessorImplementation(GameControllerClient gameControllerClient) {
        this.gameControllerClient = gameControllerClient;
    }

    @Override
    public boolean keyDown(int keycode) {
        return gameControllerClient.sendInputEvent(new ButtonPressEvent(keycode));
    }
